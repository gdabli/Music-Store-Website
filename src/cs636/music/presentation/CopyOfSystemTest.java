...
public class CopyOfSystemTest {
	...
	public CopyOfSystemTest(String inFile) throws Exception {
		this.inFile = inFile;
	...
	public static void main(String[] args) {
		...
		CopyOfSystemTest test = null;
		try {
			test = new CopyOfSystemTest(inFile);  
//			test.run();
//			test.adminService.getListofDownloads();
			test.userService.registerUser("joe", "smith", "joe@cs.umb.edu");
	...
	public void run() throws Exception {
		...
		while ((command = getNextCommand(in)) != null) {
			...
			} else if (command.equalsIgnoreCase("gp")) // get list of CDs
			{
				...
				userService.registerUser("joe", "smith", "joe@cs.umb.edu");
